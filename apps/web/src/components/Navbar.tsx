...
import { LayoutGrid, Settings, LogOut, User, ChevronDown, Upload, ShieldCheck } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <span className="font-bold text-lg sm:hidden">
              {config.brandName.split(' ').map(w => w[0]).join('')}
            </span>
          </Link>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <Link to="/events" className={linkClass('/events')}>
              ...
              <span className="sr-only sm:hidden">Gallery</span>
            </Link>

            {/* User Menu - only visible to authenticated admins */}
